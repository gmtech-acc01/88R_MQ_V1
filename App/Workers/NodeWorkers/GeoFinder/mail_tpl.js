...
exports.getTemplateWithData = function($data){
	return `
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainer">
									<tr>
											<td valign="top" class="bodyContent" mc:edit="body_content">
												<p>IP: ` + $data.ip + ` on ` + $data.created_at + `</p>
												<p>
                                                Above IP has been detected,<br>
                                Country : <b>` + $data.country + `</b><br>
                                City : <b>` + $data.city + `</b><br>
                                State : <b>` + $data.map_state + `</b><br>
                                Name : <b>` + $data.map_disp_name + `</b><br>
                                Road : <b>` + $data.map_road + `</b><br>
                                ISP : <b>` + $data.isp + `</b><br>
                                LAT : <b>` + $data.latitude + `</b><br>
                                LON : <b>` + $data.longitude + `</b><br>
												...
												<table border="0" cellpadding="0" cellspacing="0" valign="top">
													<tr>
														...
														<td align="left" valign="top" mc:edit="footer_sig" valign="top" style="margin:0;padding-top:10px;line-height:1;">
															<h4><strong>Grand Technologies LTD</strong></h4>
															<h5>Automatic Visitor Detector</h5>
														</td>
													</tr>
												</table>
											</td>
